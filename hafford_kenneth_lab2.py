...
while guess_count <= max_guesses:
    guess = input(f"[enter a # from {MIN}-{MAX}]: ")
    if guess == 26:
        print("THIS NUMBER IS OUT OF RANGE, THIS WILL COST 2 GUESSES")
        guess_count - 2
    elif guess is win_num - 3:
        print("Your guess is close, you have been granted another guess")
        guess_count - 1
    elif guess is win_num -2:
        print("Your guess is close, you have been granted another guess")
        guess_count - 1
    elif guess is win_num -1:
        print("Your guess is close, you have been granted another guess")
        guess_count - 1
    elif guess is win_num +3:
        print("Your guess is close, you have been granted another guess")
